...
class XBogus:
    ...
    def getXBogus(self, url_path):
        ...
        self.xb = xb_
        return self.xb #(self.params, self.xb, self.user_agent)


if __name__ == "__main__":
    url_path = "https://www.douyin.com/aweme/v1/web/aweme/post/?device_platform=webapp&aid=6383&channel=channel_pc_web"
