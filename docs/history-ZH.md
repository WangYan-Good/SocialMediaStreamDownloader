...
- ✨添加系统负载监控(CPU、内存、磁盘、网络) (2026.02.15)
- ✨实现过载条件下的弹窗预警系统 (2026.02.15)
- ✨创建API端点/api/system-load获取当前负载状态 (2026.02.15)
- ✨添加前端负载指示器显示实时指标 (2026.02.15)
- ✨在系统过载时阻止新的下载请求 (2026.02.15)
- ✨实现下载历史记录模块 (2026.02.15)
- ✨创建API端点/api/history管理下载历史 (2026.02.15)
- ✨添加前端历史记录查看器支持筛选和分页 (2026.02.15)
- ✨实现历史记录的持久化存储 (2026.02.15)
- ✨集成历史记录与下载生命周期 (2026.02.15)
- ✨实现历史账号检索功能 (2026.02.15)
- ✨添加API端点/api/history/search检索历史下载 (2026.02.15)
- ✨在下载页面添加历史账号检索界面 (2026.02.15)
- ✨支持按关键词检索历史账号 (2026.02.15)
- ✨实现点击检索结果填充下载URL (2026.02.15)
- ✨实现高级历史账号筛选功能 (2026.02.15)
- ✨添加API端点/api/history/filter支持高级筛选 (2026.02.15)
- ✨实现多种排序方式(最近、最早、频率等) (2026.02.15)
- ✨添加平台筛选功能 (2026.02.15)
- ✨为每条记录添加独立下载按钮 (2026.02.15)
- ✨实现设置模块 (2026.02.15)
- ✨添加API端点/api/config管理配置 (2026.02.15)
- ✨实现下载、日志和系统设置界面 (2026.02.15)
- ✨添加配置保存和重置功能 (2026.02.15)
- ✨实现当前配置显示功能 (2026.02.15)
