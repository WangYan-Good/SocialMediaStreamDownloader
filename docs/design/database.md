...
| admin_user_ids                | table             |      |     |         |       | "$.data.room.admin_user_ids"                      | 直播间管理员用户ID表              |
| admin_user_open_ids           | table             |      |     |         |       | "$.data.room.admin_user_open_ids"                 | 直播间管理员用户开放ID表          |
...
| comment_box                   | json              |      |     |         |       | "$.data.room.comment_box"                         | 评论框                           |
...
| user_share_text                     | text              |      |     |         |       | "$.data.room.user_share_text"                          | 用户分享文本          |
...
| resolution         | varchar(50)       |      |     |         |       | "$.data.room.stream_url.live_core_sdk_data.pull_data.options.qualities.resolution"         | 分辨率              |
| sdk_key            | varchar(100)      |      |     |         |       | "$.data.room.stream_url.live_core_sdk_data.pull_data.options.qualities.sdk_key"            | SDK密钥             |
| v_bit_rate         | unsigned bigint   |      |     |         |       | "$.data.room.stream_url.live_core_sdk_data.pull_data.options.qualities.v_bit_rate"         | 视频比特率           |
...
| resolution         | varchar(50)       |      |     |         |       | "$.data.room.stream_url.live_core_sdk_data.pull_data.options.default_quality.resolution"         | 分辨率              |
| sdk_key            | varchar(100)      |      |     |         |       | "$.data.room.stream_url.live_core_sdk_data.pull_data.options.default_quality.sdk_key"            | SDK密钥             |
| v_bit_rate         | unsigned bigint   |      |     |         |       | "$.data.room.stream_url.live_core_sdk_data.pull_data.options.default_quality.v_bit_rate"         | 视频比特率           |
